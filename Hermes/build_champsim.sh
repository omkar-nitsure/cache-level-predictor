...
if [ "$#" -ne 6 ]; then
    ...
    echo "Usage: ./build_champsim.sh [l1d_pref] [l2c_pref] [llc_pref] [llc_repl] [num_core] [num_dram_channels] [log_num_dram_channels]"
    exit 1
fi
