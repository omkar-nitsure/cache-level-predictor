...
//METADATA RAM
#define LOG2_MD_SIZE 14
#define MDRAM_CHANNELS 1
#define LOG2_MDRAM_CHANNELS 0
#define MDRAM_RANKS 1
#define LOG2_MDRAM_RANKS 0
#define MDRAM_BANKS 2
#define LOG2_MDRAM_BANKS 1
#define MDRAM_ROWS 2048
#define LOG2_MDRAM_ROWS 11
#define MDRAM_COLUMNS 64
#define LOG2_MDRAM_COLUMNS 6
#define MDRAM_ROW_SIZE (BLOCK_SIZE*MDRAM_COLUMNS/1024)

#define MDRAM_SIZE (MDRAM_CHANNELS*MDRAM_RANKS*MDRAM_BANKS*MDRAM_ROWS*MDRAM_ROW_SIZE/1024) 
#define MDRAM_PAGES ((MDRAM_SIZE<<10)>>2) 
