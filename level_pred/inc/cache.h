...
// cache level predictor Metadata cache
#define MD_SET 16
#define MD_WAY 2
#define MD_RQ_SIZE 8
#define MD_WQ_SIZE 8 
#define MD_PQ_SIZE 4
#define MD_MSHR_SIZE 4
#define MD_LATENCY 2
...
class METADATA : public MEMORY {
  public:
    ...
    // constructor
    METADATA(string v1, uint32_t v2, int v3, uint32_t v4, uint32_t v5, uint32_t v6, uint32_t v7, uint32_t v8) 
        : NAME(v1), NUM_SET(v2), NUM_WAY(v3), NUM_LINE(v4), WQ_SIZE(v5), RQ_SIZE(v6), PQ_SIZE(v7), MSHR_SIZE(v8) {
    ...
    unsigned char popular_level_detector();
